...
class Test_splitter(unittest.TestCase):
    ...
    def test_split_rasters_from_RNB_buildings(self):
        ...
        #   mkdir -p /tmp/sgis/unittests/temporary_LaCie/rasters/only_tiles/09/2025/09-2025-0M20-RGB/
        #   ls ~/temporary_LaCie/rasters/only_tiles/09/2026/09-2026-0M20-RGB/ | head -n 16 | xargs -I {} cp -rs ~/temporary_LaCie/rasters/only_tiles/09/2026/09-2026-0M20-RGB/{} /tmp/sgis/unittests/temporary_LaCie/rasters/only_tiles/09/2025/09-2025-0M20-RGB/
        ...
        t_year='2025'
        t_resolution=20
        t_threads_num=1 # 1 thread pour SEQUENTIAL MODE
        main(t_dep, t_year, t_resolution, t_threads_num, raw_folder_path=ts.UNITTESTS_FOLDER_PATH, dest_folder_path=ts.UNITTESTS_FOLDER_PATH)
    ...
    def test_multi(self):
        ##  COPIER MANUELLEMENT LES 8 PREMIERES TUILES :
        #   mkdir -p /tmp/sgis/unittests/temporary_LaCie/rasters/only_tiles/09/2026/09-2026-0M20-RGB/
        ...
        t_resolution=20
        t_threads_num=6
        test_folder = "/tmp/sgis/unittests/"
        main(t_dep, t_year, t_resolution, t_threads_num, raw_folder_path=ts.UNITTESTS_FOLDER_PATH, dest_folder_path=test_folder)
