...
parser.add_argument("--share", default=0.99999, type=float, help="Share of available images to apply prediction on. Must be different than 1.")
parser.add_argument("--gpu", default='true', choices=('true', 'false'), help="Whether the machine GPU is used for prediction")
