# nerotb 16/06/2023
#
#         This module is a very slightly modified version of 'keras.utils.image_dataset'.
#         The modification consists in the opportunity to pass a function applied on each image before it is resized
#         (i.e. before either the width/height ratio is lost or the image is cropped, default behaviour of `image_dataset_from_directory`)
#
# The original source code is for instance accessible there: https://github.com/keras-team/keras/blob/v2.9.0/keras/utils/image_dataset.py
...
def image_dataset_from_directory(directory,
  ...
  if (transform is not None) and crop_to_aspect_ratio:
      raise TypeError('If `transform` is specified, `crop_to_aspect_ratio` and resize operations will be ignored')
  if kwargs:
...
def paths_and_labels_to_dataset(image_paths,
  ...
  args = (image_size, num_channels, interpolation, transform, crop_to_aspect_ratio)
  img_ds = path_ds.map(
